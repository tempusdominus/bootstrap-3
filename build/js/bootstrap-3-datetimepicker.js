...
var DateTimePicker = function ($) {
    ...
    var DateTimePicker = function () {
        ...
        DateTimePicker.prototype._setValue = function _setValue(targetMoment) {
            ...
            if (this._isValid(targetMoment)) {
                ...
                if (!this._options.keepInvalid) {
                    if (this.input !== undefined) this.input.val('' + (this.unset ? '' : this._date.format(this.actualFormat)));
                } else {
                    this._notifyEvent({
                        type: DateTimePicker.Event.CHANGE,
                        _date: targetMoment,
        ...
        DateTimePicker.prototype.viewDate = function (_viewDate) {
            function viewDate(_x) {
                return _viewDate.apply(this, arguments);
            }

            viewDate.toString = function () {
                return _viewDate.toString();
            };
...
var Bootstrap3DateTimePicker = function ($) {
    ...
    var Bootstrap3DateTimePicker = function (_DateTimePicker) {
        _inherits(Bootstrap3DateTimePicker, _DateTimePicker);

        function Bootstrap3DateTimePicker(element, options) {
            _classCallCheck(this, Bootstrap3DateTimePicker);
        ...
        Bootstrap3DateTimePicker.prototype._init = function _init() {
        ...
        Bootstrap3DateTimePicker.prototype._getDatePickerTemplate = function _getDatePickerTemplate() {
        ...
        Bootstrap3DateTimePicker.prototype._getTimePickerMainTemplate = function _getTimePickerMainTemplate() {
            var topRow = $('<tr>'),
                middleRow = $('<tr>'),
                bottomRow = $('<tr>');
        ...
        Bootstrap3DateTimePicker.prototype._getTimePickerTemplate = function _getTimePickerTemplate() {
        ...
        Bootstrap3DateTimePicker.prototype._getToolbar = function _getToolbar() {
            var row = [];
        ...
        Bootstrap3DateTimePicker.prototype._getTemplate = function _getTemplate() {
        ...
        Bootstrap3DateTimePicker.prototype._place = function _place() {
        ...
        Bootstrap3DateTimePicker.prototype._fillDow = function _fillDow() {
            var row = $('<tr>'),
        ...
        Bootstrap3DateTimePicker.prototype._fillMonths = function _fillMonths() {
            var spans = [],
        ...
        Bootstrap3DateTimePicker.prototype._updateMonths = function _updateMonths() {
        ...
        Bootstrap3DateTimePicker.prototype._updateYears = function _updateYears() {
        ...
        Bootstrap3DateTimePicker.prototype._updateDecades = function _updateDecades() {
        ...
        Bootstrap3DateTimePicker.prototype._fillDate = function _fillDate() {
        ...
        Bootstrap3DateTimePicker.prototype._fillHours = function _fillHours() {
        ...
        Bootstrap3DateTimePicker.prototype._fillMinutes = function _fillMinutes() {
            var table = this.widget.find('.timepicker-minutes table'),
                currentMinute = this._viewDate.clone().startOf('h'),
                html = [];
            var row = $('<tr>');
            var step = this._options.stepping === 1 ? 5 : this._options.stepping;
        ...
        Bootstrap3DateTimePicker.prototype._fillSeconds = function _fillSeconds() {
        ...
        Bootstrap3DateTimePicker.prototype._fillTime = function _fillTime() {
            var toggle = void 0,
                newDate = void 0;
        ...
        Bootstrap3DateTimePicker.prototype._doAction = function _doAction(e, action) {
            ...
            switch (action) {
                ...
                case "decrementMinutes":
                    {
                        var _newDate4 = this._date.clone().subtract(options.stepping, 'm');
        ...
        Bootstrap3DateTimePicker.prototype.hide = function hide() {
            ...
            if (this.input !== undefined) this.input.blur();

            this.currentViewMode = 0;
            this._viewDate = this._date.clone();
        };

        Bootstrap3DateTimePicker.prototype.show = function show() {
        ...
        Bootstrap3DateTimePicker.prototype.destroy = function destroy() {
            this.hide();
            //todo doc off?
        ...
        Bootstrap3DateTimePicker.prototype.disable = function disable() {
            this.hide();
            if (this.component && this.component.hasClass('btn')) {
                this.component.addClass('disabled');
            }
            if (this.input !== undefined) this.input.prop('disabled', true); //todo disable this/comp if input is null
        };

        Bootstrap3DateTimePicker.prototype.enable = function enable() {
            if (this.component && this.component.hasClass('btn')) {
                this.component.removeClass('disabled');
            }
            if (this.input !== undefined) this.input.prop('disabled', false); //todo enable comp/this if input is null
        };

        Bootstrap3DateTimePicker.prototype.toolbarPlacement = function toolbarPlacement(_toolbarPlacement) {
            if (arguments.length === 0) {
        ...
        Bootstrap3DateTimePicker.prototype.widgetPositioning = function widgetPositioning(_widgetPositioning) {
            if (arguments.length === 0) {
        ...
        Bootstrap3DateTimePicker.prototype.widgetParent = function widgetParent(_widgetParent) {
            if (arguments.length === 0) {
        ...
        Bootstrap3DateTimePicker._jQueryInterface = function _jQueryInterface(option, argument) {
            return this.each(function () {
                var data = $(this).data(DateTimePicker.DATA_KEY);
                if ((typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object') {
                    $.extend(true, DateTimePicker.Default, option);
                }

                if (!data) {
                    data = new Bootstrap3DateTimePicker($(this), option);
        ...
        return Bootstrap3DateTimePicker;
    }(DateTimePicker);
    /**
     * ------------------------------------------------------------------------
     * jQuery
    ...
    var getSelectorFromElement = function getSelectorFromElement($element) {
        ...
        if ($selector.length === 0) return $element;

        var config = $selector.data(DateTimePicker.DATA_KEY) ? '' : $.extend({}, $selector.data(), $(this).data());

        return selector;
    };

    $(document).on(DateTimePicker.Event.CLICK_DATA_API, DateTimePicker.Selector.DATA_TOGGLE, function (event) {
        var $target = $(getSelectorFromElement($(this)));
        if ($target.length === 0) return;
        Bootstrap3DateTimePicker._jQueryInterface.call($target, 'toggle');
    }).on(DateTimePicker.Event.CHANGE, '.' + DateTimePicker.ClassName.INPUT, function (event) {
        var $target = $(getSelectorFromElement($(this)));
        if ($target.length === 0) return;
        Bootstrap3DateTimePicker._jQueryInterface.call($target, '_change', event);
    }).on(DateTimePicker.Event.BLUR, '.' + DateTimePicker.ClassName.INPUT, function (event) {
        var $target = $(getSelectorFromElement($(this)));
        if ($target.length === 0) return;
        var config = $target.data(DateTimePicker.DATA_KEY);
        if (config._options.debug) return;
        Bootstrap3DateTimePicker._jQueryInterface.call($target, 'hide', event);
    }).on(DateTimePicker.Event.KEYDOWN, '.' + DateTimePicker.ClassName.INPUT, function (event) {
        var $target = $(getSelectorFromElement($(this)));
        if ($target.length === 0) return;
        Bootstrap3DateTimePicker._jQueryInterface.call($target, '_keydown', event);
    }).on(DateTimePicker.Event.KEYUP, '.' + DateTimePicker.ClassName.INPUT, function (event) {
        var $target = $(getSelectorFromElement($(this)));
        if ($target.length === 0) return;
        Bootstrap3DateTimePicker._jQueryInterface.call($target, '_keyup', event);
    }).on(DateTimePicker.Event.FOCUS, '.' + DateTimePicker.ClassName.INPUT, function (event) {
        var $target = $(getSelectorFromElement($(this)));
        if ($target.length === 0) return;
        var config = $target.data(DateTimePicker.DATA_KEY);
        if (!config._options.allowInputToggle) return;
        Bootstrap3DateTimePicker._jQueryInterface.call($target, config, event);
    });

    $.fn[DateTimePicker.NAME] = Bootstrap3DateTimePicker._jQueryInterface;
    $.fn[DateTimePicker.NAME].Constructor = Bootstrap3DateTimePicker;
    $.fn[DateTimePicker.NAME].noConflict = function () {
        $.fn[DateTimePicker.NAME] = JQUERY_NO_CONFLICT;
        return Bootstrap3DateTimePicker._jQueryInterface;
    };

    return Bootstrap3DateTimePicker;
}(jQuery);
//# sourceMappingURL=eonasdan-bootstrap-datetimepicker.js.map
//# sourceMappingURL=eonasdan-bootstrap-datetimepicker.js.map
//# sourceMappingURL=eonasdan-bootstrap-datetimepicker.js.map
//# sourceMappingURL=eonasdan-bootstrap-datetimepicker.js.map
//# sourceMappingURL=bootstrap-3-datetimepicker.js.map
